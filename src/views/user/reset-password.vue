      ...
      >
        <div class='login'>
          ...
          <BaseInputConfirm
            ...
            v-model:passwordConfirmation="resetForm.password_confirmation"
...
const resetRules = reactive({
  ...
  password_confirmation: [
    {
      required: true,
      message: trans('validation.required', { _field_: trans('reset_pass.password_confirmation') }),
      trigger: 'blur',
    },
    {
    ...
    if (valid) {
      ...
      try {
        ...
        if (response.status_code === 200) {
          await router.push('/')
          await notiService.setNotifySuccess(trans('noti.reset_pass_success'))
